...
class Subdiv2DSample : ConsoleTestBase
{
    public override void RunTest()
    {
        ...
        {
            Cv2.Circle(img, (Point)p, 4, Scalar.Red, -1);
        }
        ...
        subdiv.GetVoronoiFacetList(default, out var facetList, out var facetCenters);
        ...
        foreach (var list in facetList)
        {
            ...
            {
                Cv2.Line(vonoroi, (Point)before, (Point)p, new Scalar(64, 255, 128), 1);
                before = p;
            }
        }
