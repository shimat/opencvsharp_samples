...
class SiftSurfSample : ConsoleTestBase
{
    ...
    private void MatchBySift(Mat src1, Mat src2)
    {
        ...
        sift.DetectAndCompute(gray1, default, out var keypoints1, descriptors1);
        sift.DetectAndCompute(gray2, default, out var keypoints2, descriptors2);
    ...
    private void MatchBySurf(Mat src1, Mat src2)
    {
        ...
        using var descriptors1 = new Mat<float>();
        using var descriptors2 = new Mat<float>();
        surf.DetectAndCompute(gray1, default, out var keypoints1, descriptors1);
        surf.DetectAndCompute(gray2, default, out var keypoints2, descriptors2);
